 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\VehiclePermit> $vehiclePermits
 * 
...
class Employee extends Model
{
    ...
    /**
     * Get the vehicle permits for the employee.
     */
    public function vehiclePermits(): HasMany
    {
        return $this->hasMany(VehiclePermit::class, 'employee_id', 'employee_id');
    }
}